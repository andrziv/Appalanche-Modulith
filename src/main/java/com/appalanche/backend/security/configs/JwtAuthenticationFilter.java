...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
        ...
        try {
            final String accountEmail = jwtHelper.extractEmail(jwt);
            final UUID accountId = jwtHelper.extractAccountId(jwt);

            Authentication authentication = SecurityContextHolder.getContext().getAuthentication();

            if (accountId != null && accountEmail != null && authentication == null) {
                ...
                if (jwtHelper.isTokenValid(jwt, new Account(accountId, accountEmail, ""))) {
